...
const updateTask = async (req,res) => {
    try {
        if (req.body.task === '' || req.query.taskid === '' || req.query.taskid === null)
        ...
        const psQuery2 = {
            name: 'UpdateTaskQuery',
            text: 'UPDATE tasks SET task = $1 WHERE taskid = $2 AND accid = $3',
            values: [req.body.task, req.query.taskid, decoded.accID]
        }
